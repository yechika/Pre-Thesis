# sentiment-toxicity-modeling

## Purpose

Fine-tuning empat model deep learning (BERT, RoBERTa, DistilBERT, Detoxify) untuk klasifikasi sentimen + toksisitas via transfer learning.
